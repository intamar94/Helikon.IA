...
export const CERTIFICACIONES_SEED: Certificacion[] = [
  {
    id: "cert-aerocampo-co",
    titular_tipo: "operador",
    titular_id: "op-aerocampo",
    pais_id: "co",
  ...
  // Sólo importan en anuncios de alquiler: ahí vuela el productor, así que la
  // licencia tiene que estar a su nombre.
  {
    // Estancia grande del Valle: tiene el aval de la CVC a nombre propio, así
    // que puede alquilar un equipo y volarlo ella misma.
    id: "cert-el-palmar-co",
    titular_tipo: "productor",
    titular_id: "pr-el-palmar",
    pais_id: "co",
    tipo_certificacion: "Licencia ICA Aplicador Aéreo + Aval CVC",
    numero: "CVC-AVAL-2026-0210",
    vigente_hasta: "2027-12-31",
    documento_url: "https://docs.helikon.ia/cert/CVC-AVAL-2026-0210.pdf",
    documento_revisado: true,
  },
  {
    // Tiene la licencia nacional, pero la regla de Sinaloa exige además el
    // aval estatal: alcanza para alquilar en Jalisco, no en Sinaloa.
    id: "cert-san-miguel-mx",
    titular_tipo: "productor",
    titular_id: "pr-san-miguel",
    pais_id: "mx",
    tipo_certificacion: "Licencia SENASICA Aplicador con RPAS",
    numero: "SEN-RPAS-2026-7781",
    vigente_hasta: "2027-10-31",
    documento_url: "https://docs.helikon.ia/cert/SEN-RPAS-2026-7781.pdf",
    documento_revisado: true,
  },
];
...
/**
 * Publicaciones. Un mismo dron puede estar anunciado con piloto y en alquiler,
 * a precios distintos: son dos productos comerciales sobre el mismo equipo.
 */
export const ANUNCIOS_SEED: Anuncio[] = [
  {
    id: "an-aerocampo-t40-piloto",
    dron_id: "dr-aerocampo-t40",
    modalidad: "con_piloto",
    servicios_ofrecidos: ["fumigacion", "dispersion_solidos"],
    precio_hectarea_usd: 11.5,
    precio_dia_usd: null,
    horas_por_jornada: 6,
    activo: true,
  },
  {
    id: "an-aerocampo-t40-alquiler",
    dron_id: "dr-aerocampo-t40",
    modalidad: "alquiler",
    servicios_ofrecidos: ["fumigacion", "dispersion_solidos"],
    precio_hectarea_usd: null,
    precio_dia_usd: 420,
    horas_por_jornada: 6,
    activo: true,
  },
  {
    id: "an-aerocampo-p4-piloto",
    dron_id: "dr-aerocampo-p4",
    modalidad: "con_piloto",
    servicios_ofrecidos: ["mapeo_ndvi"],
    precio_hectarea_usd: 3.2,
    precio_dia_usd: null,
    horas_por_jornada: 6,
    activo: true,
  },
  {
    id: "an-aerocampo-p4-alquiler",
    dron_id: "dr-aerocampo-p4",
    modalidad: "alquiler",
    servicios_ofrecidos: ["mapeo_ndvi"],
    precio_hectarea_usd: null,
  ...
  {
    id: "an-dronagro-t50-piloto",
    dron_id: "dr-dronagro-t50",
    modalidad: "con_piloto",
    servicios_ofrecidos: ["fumigacion", "dispersion_solidos", "siembra"],
    precio_hectarea_usd: 12.9,
    precio_dia_usd: null,
    horas_por_jornada: 6,
    activo: true,
  },
  {
    id: "an-dronagro-t50-alquiler",
    dron_id: "dr-dronagro-t50",
    modalidad: "alquiler",
  ...
  {
    id: "an-fumiga-t30-piloto",
    dron_id: "dr-fumiga-t30",
    modalidad: "con_piloto",
    servicios_ofrecidos: ["fumigacion"],
    precio_hectarea_usd: 10.4,
    precio_dia_usd: null,
    horas_por_jornada: 6,
    activo: true,
  },
  {
    id: "an-andes-t40-piloto",
    dron_id: "dr-andes-t40",
    modalidad: "con_piloto",
    servicios_ofrecidos: ["fumigacion", "mapeo_ndvi"],
    precio_hectarea_usd: 9.8,
    precio_dia_usd: null,
    horas_por_jornada: 6,
    activo: true,
  },
  {
    id: "an-sinaloa-t50-piloto",
    dron_id: "dr-sinaloa-t50",
    modalidad: "con_piloto",
    servicios_ofrecidos: ["fumigacion", "dispersion_solidos", "siembra"],
    precio_hectarea_usd: 13.4,
    precio_dia_usd: null,
    horas_por_jornada: 6,
    activo: true,
  },
  {
    id: "an-sinaloa-t50-alquiler",
    dron_id: "dr-sinaloa-t50",
    modalidad: "alquiler",
    servicios_ofrecidos: ["fumigacion", "siembra"],
    precio_hectarea_usd: null,
  ...
  {
    id: "an-bajio-t40-piloto",
    dron_id: "dr-bajio-t40",
    modalidad: "con_piloto",
    servicios_ofrecidos: ["fumigacion", "mapeo_ndvi"],
    precio_hectarea_usd: 12.1,
    precio_dia_usd: null,
    horas_por_jornada: 6,
    activo: true,
  },
  {
    id: "an-cerrado-t50-piloto",
    dron_id: "dr-cerrado-t50",
    modalidad: "con_piloto",
    servicios_ofrecidos: ["fumigacion", "siembra"],
    precio_hectarea_usd: 10.9,
    precio_dia_usd: null,
    horas_por_jornada: 6,
    activo: true,
  },
  {
    id: "an-cerrado-t50-alquiler",
    dron_id: "dr-cerrado-t50",
    modalidad: "alquiler",
    servicios_ofrecidos: ["fumigacion", "siembra"],
    precio_hectarea_usd: null,
